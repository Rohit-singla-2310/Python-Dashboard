...
with left_column:
    dashboard3 = load_lottieurl("https://assets3.lottiefiles.com/packages/lf20_qp1q7mct.json")
    st_lottie(dashboard3, key="Dashboard3", height=400)
with right_column:
    dashboard4 = load_lottieurl("https://assets3.lottiefiles.com/packages/lf20_qpsnmykx.json")
    st_lottie(dashboard4, key="Dashboard4", height=400)
...
colors = ['#890DA2', 'cyan', '#FA9D3B', '#C03B83', '#DE6164', '#EF7E50']
...
Product_Rating_bar = px.bar(
    ...
    color_discrete_sequence=["orange"] * len(product_line_Rating),
    template="plotly_dark"
)
